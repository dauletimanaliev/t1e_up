"""
Professional Telegram Bot for Tie Shop
"""
...
from database import get_or_create_user, update_user_language, get_user_language, create_order, get_user_orders
...
class TieShopBot:
    ...
    def run(self):
        """Run the bot"""
        logger.info("Starting T1EUP Tie Shop Bot...")
